class NetSystem::SocketGenerator < DevSystem::ControllerGenerator
  ...
  # liza g socket name action_1 action_2 action_3
  def call_default
    set_default_super ""
  ...
  # liza g socket:simple name action_1 action_2 action_3
  def call_simple
