class NetSystem::FilebaseGenerator < DevSystem::ControllerGenerator
  ...
  # liza g filebase name action_1 action_2 action_3
  def call_default
    set_default_super ""
  ...
  # liza g filebase:simple name action_1 action_2 action_3
  def call_simple
