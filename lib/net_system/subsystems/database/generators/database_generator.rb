class NetSystem::DatabaseGenerator < DevSystem::ControllerGenerator
  ...
  # liza g database name action_1 action_2 action_3
  def call_default
    set_default_super ""
  ...
  # liza g database:simple name action_1 action_2 action_3
  def call_simple
